  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        ...
        interfaces: [
          ...
          { id: 'eth1', name: 'eth1', ipAddress: '10.0.1.1', prefixLength: 30, macAddress: '00:00:00:01:00:01' },
        ],
        staticRoutes: [
    ...
    },
    {
      ...
      data: {
        ...
        layerId: 'l3',
        interfaces: [
          { id: 'eth0', name: 'eth0', ipAddress: '10.0.1.2', prefixLength: 30, macAddress: '00:00:00:02:00:00' },
          { id: 'eth1', name: 'eth1', ipAddress: '10.0.0.1', prefixLength: 24, macAddress: '00:00:00:02:00:01' },
        ],
        staticRoutes: [
          { destination: '10.0.1.0/30', nextHop: 'direct' },
...
function findTrace(engine: SimulationEngine, packetId: string): PacketTrace | undefined {
...
function SessionDemoInner() {
  ...
  const handleSend = async () => {
    ...
    try {
      const request = new Request('https://netlab.local/api/data', { method: 'GET' });
      const response = new Response(JSON.stringify({ ok: true, source: 'server' }), {
        status: 200,
    ...
    <div style={{ display: 'flex', height: '100%' }}>
      <div style={{ flex: 1, position: 'relative', minWidth: 0 }}>
        ...
        >
          ...
          <span style={{ color: '#94a3b8', fontFamily: 'monospace', fontSize: 11 }}>
            ...
            {failureCount > 0 ? ` · ${failureCount} failure${failureCount === 1 ? '' : 's'} active` : ''}
          </span>
        </div>
      </div>
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <div style={{ borderTop: '1px solid #1e293b', padding: 12, minHeight: 220, maxHeight: 320 }}>
            <FailureTogglePanel />
          </div>
        </div>
      </ResizableSidebar>
