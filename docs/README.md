...
- [Local ESLint Rules](dev/eslint-rules.md) - Project-specific lint rules, fix recipes, and escape hatches
...
- [Protocol Concept Checks](learning/concept-check.md) - Data-driven active-recall quizzes spanning 18 protocols across the stack (Ethernet/ARP/STP/VLAN, IPv4/IPv6/ICMP/NAT, TCP/UDP/QUIC, DNS/DHCP/HTTP, TLS, OSPF/BGP/RIP), built to scale to almost any protocol
...
- [Demo Experience](ui/demo-experience.md) - Next demo-surface improvements for scenario metadata, gallery browsing, and progressive disclosure
...
Historical design handoffs and specs generated by agent-assisted planning.

- [Interactive Sandbox Design Spec](superpowers/specs/2026-04-21-interactive-sandbox-design.md) - Sandbox design decisions and interaction model
- [Design Handoff Plan](superpowers/plans/2026-04-30-design-handoff.md) - Handoff plan for reviewable design artifacts
