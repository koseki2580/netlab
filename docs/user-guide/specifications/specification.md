...
| REQ-052     | AC-052         | TC-156, TC-157, TC-158, TC-159, TC-160, TC-163, TC-164, TC-165                 | `e2e/lesson-chrome-locale.spec.ts`<br>`src/components/NetlabProvider.test.tsx`                      | Using the gallery   | Verified |
