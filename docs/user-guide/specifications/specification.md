...
- **REQ-052 (MUST):** The controls every lesson shares — the packet timeline,
  ...
  legend, and the lesson's name and summary at the top of the page. A lesson's
  own teaching copy MUST follow it too, translated lesson by lesson with the
  beginner lessons first. Hop events (`CREATE`, `FWD`, `DELIVER`, `DROP`) and drop reasons
...
| TC-166    | AC-052     | E2E           | Each lesson listed as translated, with Japanese chosen       | It is opened and its primary action pressed                                       | No line of English prose remains; readouts, codes and names may                      | `e2e/lesson-japanese.spec.ts`                                 |
...
| REQ-052     | AC-052         | TC-156, TC-157, TC-158, TC-159, TC-160, TC-163, TC-164, TC-165, TC-166, TC-167 | `e2e/lesson-chrome-locale.spec.ts`<br>`e2e/lesson-japanese.spec.ts`<br>`src/components/NetlabProvider.test.tsx` | Using the gallery   | Verified |
