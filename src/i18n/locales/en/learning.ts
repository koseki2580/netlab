...
export const learning: Catalog = {
  ...
  'learning.progress.badge.completedScore': 'Completed {{passed}}/{{total}}',
  'learning.progress.badge.completed': 'Completed',
  'learning.progress.badge.pending': 'Pending',
  'learning.progress.panel.exportButton': 'Export JSON',
  'learning.progress.panel.clear': 'Clear progress',
  'learning.progress.panel.complete': 'Complete',
  'learning.progress.panel.imported': 'Imported',
  'learning.progress.panel.importFailed': 'Import failed: {{reason}}',
  'learning.progress.panel.importButton': 'Import JSON',
  'learning.progress.panel.confirmClearLabel': 'Confirm clear progress',
  'learning.progress.panel.confirmClear': 'Confirm clear',
  'learning.progress.panel.cancel': 'Cancel',
} as const;
