...
export const conceptCheck: Catalog = {
  ...
  'learning.concept.primer.body':
    'トピックを選び、いくつかの問いに答えて理解度を確認します。誤答の場合はまず「その選択肢がなぜ誤りか」を示してから一般的な解説が続き、セッション終了時にスコアが出ます。トピックは L2 からセキュリティまでスタックを横断します。',
  'learning.concept.pickDeck': 'ドリルするトピックを選択',
  'learning.concept.search': 'トピックを絞り込み（例: BGP、TLS）',
  'learning.concept.searchEmpty': '「{{query}}」に一致するトピックがありません。',
  'learning.concept.streak': '{{count}}問連続正解',
  'learning.concept.backToDecks': '← すべてのトピック',
  ...
  'learning.concept.arp.q2.a': 'ターゲットホスト自身の MAC',
  'learning.concept.arp.q2.b': 'ブロードキャスト ff:ff:ff:ff:ff:ff',
  'learning.concept.arp.q2.c': 'デフォルトゲートウェイの MAC アドレス',
  'learning.concept.arp.q2.why':
    'まだターゲットの MAC を知らないため、リクエストはセグメント全体にブロードキャストされます。',
  'learning.concept.arp.q3.prompt': 'ARP が働く範囲は…',
  'learning.concept.arp.q3.a': 'インターネット全体の範囲',
  'learning.concept.arp.q3.b': 'ルータとルータの間だけ',
  'learning.concept.arp.q3.c': '単一のブロードキャストドメイン',
  ...
  'learning.concept.stp.q3.a': 'スイッチから物理的に切断されている',
  'learning.concept.stp.q3.b': 'データを転送するが BPDU を無視する',
  'learning.concept.stp.q3.c': 'BPDU は処理するがデータは転送しない',
  ...
  'learning.concept.vlan.q1.b': 'スイッチ間の新しい物理ケーブル',
  'learning.concept.vlan.q1.c': 'サブネット用のルーティングテーブル',
  ...
  'learning.concept.vlan.q2.a': '単一の VLAN のみ（タグなし）',
  'learning.concept.vlan.q2.b': '802.1Q タグ付きの複数 VLAN',
  'learning.concept.vlan.q2.c': 'タグなしトラフィックのみ・単一 VLAN',
  ...
  'learning.concept.udp.q1.a': '失われたデータの再送を加える',
  'learning.concept.udp.q1.b': 'データの順序を保証する',
  ...
  'learning.concept.nat.q1.a': '多数のプライベートホストが公開 IP を共有',
  'learning.concept.nat.q1.b': 'スイッチが MAC アドレスを学習',
  'learning.concept.nat.q1.c': 'ルータが OSPF を実行して経路交換',
  ...
  'learning.concept.nat.q2.a': 'デフォルトルートの設定',
  'learning.concept.nat.q2.b': 'ポートフォワーディング（DNAT）',
  'learning.concept.nat.q2.c': 'VLAN トランクの設定',
  ...
  'learning.concept.nat.q3.a': '外へ出るトラフィックを暗号化するため',
  'learning.concept.nat.q3.b': 'セグメントのルートブリッジを選出するため',
  ...
  'learning.concept.dns.q3.a': '自分が持つゾーンからのみ答える',
  'learning.concept.dns.q3.b': 'MAC アドレスだけをキャッシュする',
  'learning.concept.dns.q3.c': '答えが出るまで他サーバへ問い合わせる',
  ...
  'learning.concept.tls.q1.a': '異なるネットワーク間のルーティング',
  'learning.concept.tls.q1.b': '暗号化・完全性・サーバ認証',
  'learning.concept.tls.q1.c': 'クライアントへの IP アドレス割り当て',
  ...
  'learning.concept.tls.q2.a': '提示する MAC アドレス',
  'learning.concept.tls.q2.b': 'セッションの VLAN タグ',
  ...
  'learning.concept.tls.q3.a': '信頼できるトランスポート（TCP）の上',
  'learning.concept.tls.q3.b': 'IP よりも下の層で動作',
  'learning.concept.tls.q3.c': 'イーサネットの代わりとして',
  ...
  'learning.concept.ethernet.q2.a': '転送する全パケットの IP ヘッダを読む',
  'learning.concept.ethernet.q2.b': '受信フレームの送信元 MAC を学習する',
  'learning.concept.ethernet.q2.c': '隣接と OSPF を動かす',
  ...
  'learning.concept.icmp.q2.a': 'ARP リクエストの送信',
  'learning.concept.icmp.q2.b': 'ICMP Time Exceeded',
  'learning.concept.icmp.q2.c': 'TCP RST の送信',
  ...
  'learning.concept.icmp.q3.a': '利用者のアプリケーションデータ',
  'learning.concept.icmp.q3.b': 'ルータ間のルーティングテーブル',
  ...
  'learning.concept.ipv4.q1.a': 'ルータを越えるたびパケットを暗号化する',
  'learning.concept.ipv4.q1.b': '各ルータで減算されループを防ぐ',
  'learning.concept.ipv4.q1.c': 'キュー内での優先度を設定する',
  ...
  'learning.concept.ospf.q2.a': '最小のホップ数',
  'learning.concept.ospf.q2.b': '総リンクコストが最小',
  'learning.concept.ospf.q2.c': '最短の AS パス長',
  ...
  'learning.concept.bgp.q1.a': '自律システム間をルーティングする',
  'learning.concept.bgp.q1.b': 'ホストに IP アドレスを割り当てる',
  'learning.concept.bgp.q1.c': '名前をアドレスに解決する',
  ...
  'learning.concept.bgp.q2.a': 'ホップ数が最小の経路',
  'learning.concept.bgp.q2.b': 'ポリシーと AS パス（パスベクタ）',
  'learning.concept.bgp.q2.c': 'リンクコストの合計が最小の経路',
  ...
  'learning.concept.rip.q1.b': 'リンクコスト（OSPF と同じ）',
  'learning.concept.rip.q1.c': 'AS パス長（BGP と同じ）',
  'learning.concept.rip.q1.why':
    'RIP はルータのホップ数を数え、回線速度に関わらず最少ホップが勝ちます。',
  'learning.concept.rip.q2.prompt': 'RIP の使用可能な最大ホップ数は…',
  'learning.concept.rip.q2.a': '255 ホップ',
  'learning.concept.rip.q2.b': '15 ホップ',
  'learning.concept.rip.q2.c': '上限なし',
  'learning.concept.rip.q2.why':
    'RIP は 15 ホップが上限で、16 は「無限大」。このため小規模ネットワーク向けです。',
  'learning.concept.rip.q3.prompt': 'OSPF と比べて RIP は…',
  'learning.concept.rip.q3.a': '変化のあとの収束が速い',
  'learning.concept.rip.q3.b': 'はるかに大きい網に拡張できる',
  ...
  'learning.concept.http.q3.a': 'リクエストが成功した',
  'learning.concept.http.q3.b': 'サーバ側でエラーが起きた',
  ...
  'learning.concept.quic.q2.a': '暗号化を行わない分だけ軽い',
  'learning.concept.quic.q2.b': '接続確立が速い（1-RTT や 0-RTT）',
  'learning.concept.quic.q2.c': 'スループットが低いぶん安定する',
  ...
  'learning.concept.http2.q1.b': 'IPsec でコネクションを暗号化する',
  'learning.concept.http2.q1.c': '下位に TCP でなく UDP を使う',
  ...
  'learning.concept.http3.q1.b': '素の TCP の上',
  'learning.concept.http3.q1.c': 'ICMP の上',
  ...
  'learning.concept.http3.q2.a': 'メタデータを多く運ぶためヘッダが大きい',
  'learning.concept.http3.q2.b': 'ストリーム間で TCP の HOL ブロッキングが無い',
  'learning.concept.http3.q2.c': '暗号化が無いぶん速くなる',
  ...
  'learning.concept.qos.q2.a': 'リンクが常に空いていて使われていない',
  'learning.concept.qos.q2.b': 'リンクが輻輳し一部が遅延に敏感',
  'learning.concept.qos.q2.c': 'リンク上にホストが 1 台だけ',
  ...
  'learning.concept.qos.q3.a': 'キューイング前にパケットを暗号化する',
  'learning.concept.qos.q3.b': 'マークされたパケットをすべて破棄する',
  'learning.concept.qos.q3.c': '優先キューイングなどホップごとの動作を適用する',
  ...
  'learning.concept.ecmp.q1.b': '宛先への経路が 1 つだけのとき',
  'learning.concept.ecmp.q1.c': '宛先へのリンクが落ちているとき',
  ...
  'learning.concept.ecmp.q2.a': 'パケットごとにランダムに選択する',
  'learning.concept.ecmp.q2.b': '5タプルのハッシュでネクストホップを選ぶ',
  'learning.concept.ecmp.q2.c': '常に最小の IP アドレスを使う',
  'learning.concept.ecmp.q2.why':
    'フロー単位ハッシュは並べ替えを避けるため接続を1 経路に保ち、異なるフローは経路間で分散します。',
  'learning.concept.ecmp.q3.prompt': 'ECMP の利点は…',
  'learning.concept.ecmp.q3.a': '転送トラフィックの暗号化',
  'learning.concept.ecmp.q3.b': 'テーブル内の経路が減る',
  ...
  'learning.concept.vrrp.q1.a': '仮想 IP による冗長なゲートウェイ',
  'learning.concept.vrrp.q1.b': 'ホスト名から IP への解決',
  'learning.concept.vrrp.q1.c': 'スイッチ間のループ防止',
  ...
  'learning.concept.vrrp.q2.a': 'グループ内の全ルータが同時に',
  'learning.concept.vrrp.q2.b': '1 台のマスタ（他はバックアップ）',
  'learning.concept.vrrp.q2.c': 'サブネットの DNS サーバ',
  ...
  'learning.concept.multicast.q1.a': '1 つの送信元から関心のある受信者へ',
  'learning.concept.multicast.q1.b': 'インターネット上の全ホストへ',
  'learning.concept.multicast.q1.c': 'ちょうど 2 ホストの間だけ',
  ...
  'learning.concept.multicast.q3.a': '特定の 1 台のホストだけを指す',
  'learning.concept.multicast.q3.b': 'スイッチ上の物理ポートを指す',
  'learning.concept.multicast.q3.c': 'グループ（IPv4 の 224.0.0.0/4）',
  ...
  'learning.concept.mtu.q1.b': 'リンクが受け付ける最小パケットサイズ',
  'learning.concept.mtu.q1.c': '経路選択に使うルーティングメトリック',
  ...
  'learning.concept.mtu.q2.a': '経路上の全ホストに ping する',
  'learning.concept.mtu.q2.b': 'DF 付きパケットを送り ICMP 応答を読む',
  'learning.concept.mtu.q2.c': 'DNS に Path MTU を尋ねる',
  ...
  'learning.concept.mtu.q3.a': 'ルータでとにかくフラグメント化される',
  'learning.concept.mtu.q3.b': '相手まで黙って配送される',
  ...
  'learning.concept.gre.q1.b': 'パケット全体を AES で暗号化する',
  'learning.concept.gre.q1.c': '各ホップで MAC アドレスを切り替える',
  ...
  'learning.concept.gre.q2.a': 'ペイロードの強力な暗号化',
  'learning.concept.gre.q2.b': 'カプセル化のみで暗号化なし',
  'learning.concept.gre.q2.c': 'トンネルのアドレス割り当て',
  ...
  'learning.concept.gre.q3.b': '互いに到達不能に見せる',
  ...
  'learning.concept.mpls.q3.a': 'HTTP の上、アプリケーション内',
  'learning.concept.mpls.q3.b': 'イーサネットの下、物理リンク上',
  ...
  'learning.concept.vxlan.q1.b': 'IPv6 パケットのみ（IPv4 は不可）',
  'learning.concept.vxlan.q1.c': 'ピア間のルーティングテーブル',
  ...
  'learning.concept.vxlan.q2.b': 'VNI（24 ビットの識別子）',
  'learning.concept.vxlan.q2.c': '宛先 MAC アドレス',
  ...
  'learning.concept.vxlan.q3.a': 'トンネル両端の間でフレームを暗号化するため',
  'learning.concept.vxlan.q3.b': 'テナントに IP を割り当てるため',
  'learning.concept.vxlan.q3.c': 'MAC/IP 到達性を BGP で配布するため',
  ...
  'learning.concept.acl.q2.a': 'どんな場合も遅い',
  'learning.concept.acl.q2.b': '接続を追跡し応答を自動許可する',
  'learning.concept.acl.q2.c': 'ポート番号を完全に無視する',
  ...
  'learning.concept.model.q3.a': '各層で全パケットを暗号化する',
  'learning.concept.model.q3.b': '送信前に全ヘッダを捨てる',
  ...
  'learning.concept.model.q4.b': 'アプリケーション層（L7）',
  'learning.concept.model.q4.c': '物理層（L1）',
  ...
  'learning.concept.model.q5.a': 'トランスポート層（L4）',
  'learning.concept.model.q5.b': 'データリンク層（L2 / MAC）',
  'learning.concept.model.q5.c': 'ネットワーク層（L3）',
  ...
  'learning.concept.model.q6.a': 'カプセル化されたもう 1 つの IP ヘッダ',
  'learning.concept.model.q6.b': '次ホップ宛の MAC アドレス',
  ...
  'learning.concept.addressing.q1.b': 'インターネット全体を単独で越えて',
  'learning.concept.addressing.q1.c': 'ホスト上の TCP ポートへ',
  ...
  'learning.concept.addressing.q2.a': '1 本のケーブルの中だけ',
  'learning.concept.addressing.q2.b': 'ネットワークを越えて端から端へ',
  'learning.concept.addressing.q2.c': '特定のアプリケーションへ',
  ...
  'learning.concept.addressing.q3.a': '宛先ホストの MAC アドレスへ直接届く',
  'learning.concept.addressing.q3.b': '止まらないブロードキャストになる',
  'learning.concept.addressing.q3.c': 'デフォルトゲートウェイの MAC へ',
  ...
  'learning.concept.addressing.q4.a': '再利用でき、公開インターネットには出ない',
  'learning.concept.addressing.q4.b': '公開アドレスと同じく世界で一意',
  'learning.concept.addressing.q4.c': 'ルータとスイッチだけが使う',
  ...
  'learning.concept.addressing.q5.a': '特定の 1 台のホストだけ',
  'learning.concept.addressing.q5.b': 'ブロードキャストドメイン内の全ホスト',
  'learning.concept.addressing.q5.c': '購読したグループのホストのみ',
  ...
  'learning.concept.ports.q1.b': 'パケットがどのルータを使うか',
  'learning.concept.ports.q1.c': 'ホストの MAC アドレス',
  ...
  'learning.concept.ports.q2.a': '宛先 IP アドレスだけ',
  'learning.concept.ports.q2.b': '5タプル（送信元と宛先の IP・ポート＋プロトコル）',
  'learning.concept.ports.q2.c': '送信元と宛先の MAC アドレスの対',
  ...
  'learning.concept.ports.q6.a': 'どちらも TCP ポート 80 の上で行う',
  'learning.concept.ports.q6.b': 'どちらも代わりに ICMP を使う',
  'learning.concept.ports.q6.c': 'DNS は UDP/53、HTTPS は TCP/443',
  ...
  'learning.concept.ethernet.q4.a': '壊れたフレームを検出する FCS',
  'learning.concept.ethernet.q4.b': 'フレームの到達範囲を制限する TTL',
  'learning.concept.ethernet.q4.c': 'TCP のチェックサム',
  ...
  'learning.concept.ipv4.q5.a': 'サブネットのブロードキャストアドレス',
  'learning.concept.ipv4.q5.b': 'デフォルトルート — すべてに一致',
  'learning.concept.ipv4.q5.c': '無視される無効なエントリ',
  ...
  'learning.concept.tcp.q5.a': '受信側だけが読めるようデータを暗号化するため',
  'learning.concept.tcp.q5.b': '受信側と網を溢れさせないため',
  'learning.concept.tcp.q5.c': '両端に IP を割り当てるため',
  ...
  'learning.concept.udp.q5.a': 'UDP が与える暗号化が要るから',
  'learning.concept.udp.q5.b': '小さな問い合わせと応答は簡単に再試行できるから',
  'learning.concept.udp.q5.c': 'UDP が与える厳密な順序が要るから',
  'learning.concept.udp.q5.why':
    '単一の小さなやり取りに TCP の確立コストは見合わず、損失時はクライアントが再試行するだけです。',
  'learning.concept.dns.q4.prompt': 'DNS 応答のキャッシュは…',
  'learning.concept.dns.q4.a': '再参照を高速化する（TTL を尊重）',
  'learning.concept.dns.q4.b': '返される IP アドレスを変える',
  'learning.concept.dns.q4.c': 'DNS 標準で禁止されている',
  ...
  'learning.concept.ssh.q1.b': 'サーバへの平文ファイル転送',
  'learning.concept.ssh.q1.c': 'クライアントへの IP アドレス割り当て',
  ...
  'learning.concept.ssh.q3.a': 'スイッチポートでの MAC フィルタリング',
  'learning.concept.ssh.q3.b': 'セッションへの VLAN タグ付与',
  ...
  'learning.concept.ftp.q1.b': 'ファイルごとに単一の UDP データグラム',
  'learning.concept.ftp.q1.c': 'データ転送に ICMP メッセージ',
  ...
  'learning.concept.ftp.q3.a': 'データ用の接続を暗号化するため',
  'learning.concept.ftp.q3.b': 'DNS の名前解決を速くするため',
  'learning.concept.ftp.q3.c': 'クライアント側のファイアウォールを通すため',
  ...
  'learning.concept.email.q1.a': 'メールボックスからメールを受信する',
  'learning.concept.email.q1.b': 'サーバ間でメールを送信する',
  'learning.concept.email.q1.c': 'ホストに IP を割り当てる',
  ...
  'learning.concept.ntp.q2.b': 'ストラタム（0、1、2 …）',
  'learning.concept.ntp.q2.c': '自律システム単位のグループ',
  ...
  'learning.concept.snmp.q1.b': 'サブネット間のパケットのルーティング',
  'learning.concept.snmp.q1.c': '機器間のリンクの暗号化',
  ...
  'learning.concept.isis.q1.a': 'リンクステート IGP（OSPF 同様）',
  'learning.concept.isis.q1.b': 'ディスタンスベクタ型プロトコル',
  'learning.concept.isis.q1.c': 'アプリケーション層のプロトコル',
  'learning.concept.isis.q1.why':
    'IS-IS は IGP（内部ゲートウェイプロトコル）で、リンク状態をフラッディングして SPF を走らせます。大規模な ISP 網で広く使われます。',
  ...
  'learning.concept.isis.q3.a': '最短の AS パス長',
  'learning.concept.isis.q3.b': '最小の MAC アドレス',
  'learning.concept.isis.q3.c': '総リンクコストが最小',
  ...
  'learning.concept.eigrp.q1.a': '高度なディスタンスベクタ型',
  'learning.concept.eigrp.q1.b': '純粋なリンクステート型プロトコル',
  'learning.concept.eigrp.q1.c': 'アプリケーション層のプロトコル',
  ...
  'learning.concept.eigrp.q3.a': 'ホップ数のみ（RIP と同じ）',
  'learning.concept.eigrp.q3.b': 'AS パス長（BGP と同じ）',
  ...
  'learning.concept.lacp.q2.a': 'リンク用の新しい IP サブネット',
  'learning.concept.lacp.q2.b': '帯域増加とリンク冗長性',
  'learning.concept.lacp.q2.c': '束ねたリンク全体の暗号化',
  'learning.concept.lacp.q2.why':
    'トラフィックはメンバリンクにハッシュ分散され、1 本が落ちても他が継続します。',
  'learning.concept.lacp.q3.prompt': 'STP は正しい LACP 束を…',
  'learning.concept.lacp.q3.a': 'ブロックすべき複数のループとして扱う',
  'learning.concept.lacp.q3.b': 'ルータ 1 台として扱う',
  'learning.concept.lacp.q3.c': '単一の論理リンクとして扱う',
  ...
  'learning.concept.lldp.q1.b': 'サブネット間を自動でルーティングする',
  'learning.concept.lldp.q1.c': 'ローカルリンク上でフレームを暗号化する',
  'learning.concept.lldp.q1.why':
    '機器は識別情報・ポート・能力を広告し、隣接が局所トポロジを学びます（CDP は Cisco 版）。',
  'learning.concept.lldp.q2.prompt': 'LLDP が動作するのは…',
  'learning.concept.lldp.q2.a': 'インターネット全体にまたがって',
  'learning.concept.lldp.q2.b': 'リンク単位・単一セグメント内',
  'learning.concept.lldp.q2.c': 'TCP コネクションの上',
  'learning.concept.lldp.q2.why':
    'LLDP フレームはリンクローカルで、スイッチやルータに転送されません。',
  'learning.concept.lldp.q3.prompt': 'LLDP がよく使われるのは…',
  'learning.concept.lldp.q3.a': '隣接機器への IP アドレス割り当て',
  'learning.concept.lldp.q3.b': 'サブネット間の経路選択',
  ...
  'learning.concept.tunneling.q1.a': '元のパケットを新しい外側ヘッダで包む',
  ...
  'learning.concept.tunneling.q2.b': '入口が外側ヘッダを付け、出口が剥がす',
  'learning.concept.tunneling.q2.c': '受信側だけが外側ヘッダを付ける',
  ...
  'learning.concept.tunneling.q3.a': '経路そのものが遅くなるから',
  'learning.concept.tunneling.q3.b': '内側パケットが必ず暗号化されるから',
  'learning.concept.tunneling.q3.c': '外側ヘッダの分だけバイトを消費するから',
  ...
  'learning.concept.vpn.q1.a': '信頼できない網越しに暗号化トンネルを作る',
  ...
  'learning.concept.vpn.q2.a': 'サイト間は暗号化がまったく不要',
  'learning.concept.vpn.q2.b': 'サイト間は網同士、リモートアクセスは端末 1 台を接続する',
  ...
  'learning.concept.vpn.q3.c': '一部の通信だけ VPN を通す',
  ...
  'learning.concept.wireguard.q1.a': 'TCP（完全な TLS ハンドシェイク付き）',
  'learning.concept.wireguard.q1.b': '単一の軽量なポートの UDP',
  'learning.concept.wireguard.q1.c': 'ICMP（ping と同じ）',
  ...
  'learning.concept.wireguard.q2.a': 'ユーザ名とパスワードの組',
  'learning.concept.wireguard.q2.b': 'リンク上の MAC アドレス',
  'learning.concept.wireguard.q2.c': '公開鍵（許可 IP に紐づく）',
  ...
  'learning.concept.wireguard.q3.a': 'コードベースが小さく暗号方式が固定だから',
  'learning.concept.wireguard.q3.b': '速度のため暗号化を一切行わない',
  ...
  'learning.concept.l2tp.q1.a': '全通信に対する強力な暗号化',
  'learning.concept.l2tp.q1.b': '暗号化なし — トンネリングのみ',
  ...
  'learning.concept.l2tp.q3.a': 'IPsec がトンネルを速くするから',
  'learning.concept.l2tp.q3.b': 'L2TP が NAT を一切越えられないから',
  'learning.concept.l2tp.q3.c': 'L2TP がトンネルを担い、IPsec が暗号化を加えるから',
  ...
  'learning.concept.pppoe.q1.a': 'L2 カプセル化と認証（PAP/CHAP）',
  ...
  'learning.concept.pppoe.q2.b': 'PPP セッションを Ethernet フレーム内で運ぶ',
  ...
  'learning.concept.pppoe.q3.a': 'リンク用のセッション鍵を暗号化する',
  'learning.concept.pppoe.q3.b': '顧客の IP アドレスを割り当てる',
  'learning.concept.pppoe.q3.c': 'アクセス集約装置を選びセッション ID を確立する',
  ...
  'learning.concept.sip.q1.a': '実際の音声・映像メディアの運搬',
  'learning.concept.sip.q1.b': 'リアルタイム通話の確立・変更・切断',
  'learning.concept.sip.q1.c': '電話機への IP アドレスの割り当て',
  ...
  'learning.concept.sip.q2.c': 'いいえ — メディアは別途 RTP で流れる',
  ...
  'learning.concept.sip.q3.a': 'HTTP — ステータスコードを持つテキストの要求/応答',
  'learning.concept.sip.q3.b': 'バイナリのルーティングプロトコルの更新',
  'learning.concept.sip.q3.c': 'ヘッダと FCS を持つ Ethernet フレーム',
  ...
  'learning.concept.rtp.q3.b': 'メディアストリーム全体のバックアップ',
  'learning.concept.rtp.q3.c': '送信側向けの制御・品質フィードバック',
  ...
  'learning.concept.stun.q1.a': 'メディアサーバまでの最速経路',
  'learning.concept.stun.q1.b': '発信しようとしているピアの DNS 名',
  'learning.concept.stun.q1.c': '自分の公開（NAT 変換後）IP アドレスとポート',
  ...
  'learning.concept.dnssec.q3.b': '各リゾルバが持つ IP 許可リストで',
  'learning.concept.dnssec.q3.c': 'ルートから下への信頼の連鎖（DS レコード）',
