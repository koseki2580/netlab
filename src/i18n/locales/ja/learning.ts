...
export const learning: Catalog = {
  ...
  'learning.progress.badge.completedScore': '完了 {{passed}}/{{total}}',
  'learning.progress.badge.completed': '完了',
  'learning.progress.badge.pending': '未完了',
  'learning.progress.panel.exportButton': 'JSON で書き出す',
  'learning.progress.panel.clear': '記録を消す',
  'learning.progress.panel.complete': '完了',
  'learning.progress.panel.imported': '読み込みました',
  'learning.progress.panel.importFailed': '読み込めませんでした: {{reason}}',
  'learning.progress.panel.importButton': 'JSON を読み込む',
  'learning.progress.panel.confirmClearLabel': '記録の消去を確認',
  'learning.progress.panel.confirmClear': '消去する',
  'learning.progress.panel.cancel': 'キャンセル',
} as const;
