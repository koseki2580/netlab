  ...
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <circle
        ...
        fillOpacity="0.2"
      />
      <line x1="7" y1="20" x2="13" y2="20" style={{ stroke: 'var(--netlab-accent-green)' }} strokeWidth="1.5" />
      <polyline points="9,17.5 7,20 9,22.5" style={{ stroke: 'var(--netlab-accent-green)' }} strokeWidth="1.5" fill="none" />
      <line x1="27" y1="20" x2="33" y2="20" style={{ stroke: 'var(--netlab-accent-green)' }} strokeWidth="1.5" />
      <polyline points="31,17.5 33,20 31,22.5" style={{ stroke: 'var(--netlab-accent-green)' }} strokeWidth="1.5" fill="none" />
      <line x1="20" y1="7" x2="20" y2="13" style={{ stroke: 'var(--netlab-accent-green)' }} strokeWidth="1.5" />
      <polyline points="17.5,9 20,7 22.5,9" style={{ stroke: 'var(--netlab-accent-green)' }} strokeWidth="1.5" fill="none" />
      <line x1="20" y1="27" x2="20" y2="33" style={{ stroke: 'var(--netlab-accent-green)' }} strokeWidth="1.5" />
      <polyline points="17.5,31 20,33 22.5,31" style={{ stroke: 'var(--netlab-accent-green)' }} strokeWidth="1.5" fill="none" />
